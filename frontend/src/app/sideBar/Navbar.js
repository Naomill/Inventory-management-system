...
const Navbar = () => {
    ...
    return (
        <div className="w-64 bg-gray-800 text-white h-screen fixed flex flex-col justify-between">
            <div>
            ...
            <div className="p-6 border-t border-gray-700 flex justify-center">
                <Link href="/" legacyBehavior>
                    <a className="bg-blue-500 text-white px-3 py-3 flex items-center justify-center rounded hover:bg-blue-600">
                        GO to Home page
                    </a>
                </Link>
            </div>
